define([ 'util/requestUtil', 'core/base','util/formatUtil',
	...
	var OperaMenuList = function() {
		
	};

    OperaMenuList.prototype = new Base();
	
	var sessionId;

    OperaMenuList.prototype.queryParams = function(params) {
        var me = this;
	...
	// 页面初始化
    OperaMenuList.prototype.create = function() {
    	//alert("页面初始化！");
		var me = this;
		me.renderMainContent("tpl_operaMenuList");
		me.renderPage();
		me.bindEvent();
    ...
    OperaMenuList.prototype.renderPage = function() {
		var me=this;
		var operateEvents = {
	...
	//清空数据
    OperaMenuList.prototype.clearList = function() {
        var me = this;
    };
    
    
	// 重新显示
    OperaMenuList.prototype.show = function() {
		
	};
	
	//页面点击
    OperaMenuList.prototype.bindEvent = function() {
		var me = this;
       ...
       /* me.find("#varGroupId").click(function() {
        ...
        me.find(".twoMenuAdd").click(function() {
            //页面跳转
            me.moveTo('operaTwoMenuDetail');
        });

	};
	
	// 页面隐藏
    OperaMenuList.prototype.hide = function() {
		
	};

	return new OperaMenuList();
});