(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        var $chooseBtn = $('' +
         ...
         '<button class="ssi-button up-btn iconfont icon-picture">' + this.language.chooseFiles + '</button>' +
         '</span>').append(element);
            ...
            if (thisS.options.preview) {
                var getTemplate = function (content) {
                    return '<table class="ssi-imgToUploadTable ssi-pending">' +
                     ...
                     '<tr><td><button data-delete="' + index + '" class=" ssi-button ssi-removeBtn"><span class="trash10 trash"></span></button></td></tr></table>'
                };
