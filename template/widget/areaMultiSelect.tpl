<script id="area-multi-select-template" type="text/x-jsrender">
<div class="popover area-multi-select-list-popover" role="tooltip">
	<div class="arrow"></div>
...
<script id="area-multi-select-content-template" type="text/x-jsrender">
<div class="area-multi-select-list" id="{{:uid}}">
...
<script id="area-multi-select-item-template" type="text/x-jsrender">  
  <ul class="clearfix">
    {{for items}}
