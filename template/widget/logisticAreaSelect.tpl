<script id="logistic-area-select-template" type="text/x-jsrender">
<div class="popover logistic-area-select-list-popover" role="tooltip">
	<div class="arrow"></div>
...
<script id="logistic-area-select-content-template" type="text/x-jsrender">
<div class="logistic-area-select-list" id="{{:uid}}">
	...
	<div class="operation-footer">
	  <input type="text" class="form-control" maxlength="6" name="deliveryPrice" placeholder="运费">
		<button class="btn btn-default" name="confirm">添加</button>
		<button class="btn btn-default" name="selectAll">全选</button>
	</div>
</div>
</script>

<script id="logistic-area-select-item-template" type="text/x-jsrender">  
  <ul class="clearfix">
    {{for items}}
